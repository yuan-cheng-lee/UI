...
"}")
        ...
        self.frame_top_info.setMaximumSize(QtCore.QSize(16777215, 23))
...
"}")
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.frame_top_info)
...
"}")
        ...
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_top_info)
...
"}")
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.page_camera)
        ...
        self.camera.setMinimumSize(QtCore.QSize(350, 0))
        ...
        self.listView = QtWidgets.QListView(self.page_camera)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.textBrowser = QtWidgets.QTextBrowser(self.page_camera)
...
"}")
        ...
        self.groupBox = QtWidgets.QGroupBox(self.page_setting)
        self.groupBox.setGeometry(QtCore.QRect(10, 20, 321, 211))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.Exposure_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        self.Exposure_doubleSpinBox.setFont(font)
        self.Exposure_doubleSpinBox.setStyleSheet("QDoubleSpinBox{\n"
...
"}")
        ...
        self.width_doubleSpinBox.setStyleSheet("QDoubleSpinBox{\n"
"border: solid rgb(98,103,111);\n"
"padding-left: 10px;\n"
"background-color:rgb(98,103,111);\n"
"border-radius: 3px;\n"
...
"}")
        ...
        self.Height_doubleSpinBox.setStyleSheet("QDoubleSpinBox{\n"
"border: solid rgb(98,103,111);\n"
"padding-left: 10px;\n"
"background-color:rgb(98,103,111);\n"
"border-radius: 3px;\n"
...
"}")
        ...
        self.LineRate_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        self.LineRate_doubleSpinBox.setFont(font)
        self.LineRate_doubleSpinBox.setStyleSheet("QDoubleSpinBox{\n"
"border: solid rgb(98,103,111);\n"
"padding-left: 10px;\n"
"background-color:rgb(98,103,111);\n"
"border-radius: 3px;\n"
...
"border:2px solid rgbrgbrgb(91, 101, 124)\n"
"}")
        self.LineRate_doubleSpinBox.setObjectName("LineRate_doubleSpinBox")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_user_icon.setText(_translate("MainWindow", "AUO"))
        self.camera.setText(_translate("MainWindow", "camera"))
        self.camera_2.setText(_translate("MainWindow", "camera"))
        self.groupBox.setTitle(_translate("MainWindow", "相機參數"))
        ...
        self.label_4.setText(_translate("MainWindow", "Line Rate"))
